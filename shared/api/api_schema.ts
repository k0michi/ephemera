...
import { z } from "zod";
import { type RichTextBoldElement, type RichTextItalicElement, type RichTextStrikethroughElement, type RichTextElement, type RichTextNode, type RichText } from "./api.js";
...
export const richTextAnchorElementSchema = z.tuple([z.literal("anchor"), z.array(z.union([richTextAnchorAttributeSchema, richTextGlobalAttributeSchema])), z.array(z.never())]);
